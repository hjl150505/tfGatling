...
class BST:
    ...
    def build(self):
        ...
        hist_emb = self.concat_func(hist_emb_list, mask=False)
        deep_input_emb = self.concat_func(dnn_input_emb_list)
        query_emb = self.concat_func(query_emb_list, mask=False)
        ...
        self.transformer_output = Transformer(att_embedding_size=att_embedding_size, head_num=att_head_num,
                                              ...
                                              supports_masking=False, output_type=None)([hist_emb, hist_emb, user_behavior_length,user_behavior_length, query_emb])
        ...
        final_logit_tmp = tf.keras.layers.Dense(1, use_bias=False, activation=tf.keras.activations.sigmoid)(
            deep_input_emb)
