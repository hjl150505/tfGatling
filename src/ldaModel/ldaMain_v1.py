...
# 输出预测的文本的主题分布情况文件路径
path = 'text-predict-distribution.scv'
# 去除无意义字符的正则表达式
...
# 要预测的文本列表
text_to_predict_list = ['我是一个好人','我是一个坏人']

# 计算要预测的多个文本的tf-idf矩阵
text_tf_idf = tf_idf_vectorizer.transform(text_to_predict_list).toarray()
...
text_predict_df.to_csv(path,encoding='utf-8-sig',index=None)