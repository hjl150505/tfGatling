...
"""
测试 FixedLenSequenceFeature 和 parse_sequence_example
"""
...
#######################################  测试 ####################################
context_parsed = tf.io.parse_example(serialized=serialized_sequence_examples, features={**context_features, **sequence_features})
